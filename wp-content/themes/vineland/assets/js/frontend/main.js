(function ($) {
    ...
    function vineland_carousel() {
        let carousel_wrap = $('.vineland-theme-carousel'),
    ...
    function _makeStickyKit() {
        ...
        if (window.innerWidth < 992) {
            ...
            if (!$body.hasClass('vineland-drawing-side')) {
...
function vineland_slick_carousel_init($class, $data) {
// For Carousel Slider
    let data = $data,
